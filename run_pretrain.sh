...
SAVE_INTERVAL=1000
# 训练集路径
DATASET_PATH=/dataset/megatron_data/WuDaoCorpus2.0_base_sample/idxbin/wodao_qwenbpe_content_document
# 验证集路径
...
WARMUP_TOKENS=10000
# 训练输出文件路径
OUTPUT_BASEPATH=/qwen/megatron_qwen2_0.5B_PT
