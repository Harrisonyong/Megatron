...
MODEL_SIZE=0.5B
SOURCE_CKPT_PATH=/qwen/megatron_qwen2_0.5B_sft/checkpoint/etc/shinit_v2-finetune-mcore-qwen2-0.5B-lr-1e-5-bs-8-seqlen-1000-pr-fp16-tp-2-pp-2-ac-sel-do-true-sp-true-tt--wt-/iter_0031000
TARGET_CKPT_PATH=/qwen/Wedoctor-Q-0.5B-MED-20240826
TP=2
PP=2
#EP=1
PR=fp32
USE_TE=true
MG2HF=true
HF_CKPT_PATH=/qwen/qwen2_0.5B

CURRENT_DIR="$( cd "$( dirname "$0" )" && pwd )"
MEGATRON_PATH=$( dirname $(dirname $( dirname ${CURRENT_DIR})))
export PYTHONPATH=$PYTHONPATH:${MEGATRON_PATH}:${CURRENT_DIR}
